...
#let _medians = json-field("3-3-coverage.json", "medians")
#let _argmin  = json-field("3-3-coverage.json", "ic_coverage_argmin")
...
#let inter-site-count               = int-str(json-field("3-3-coverage.json", "site_count"))
#let inter-baseline-cnn-range     = range-pct(json-field("3-3-coverage.json", "baseline_coverage_per_target").cnn)
#let inter-baseline-expedia-range = range-pct(json-field("3-3-coverage.json", "baseline_coverage_per_target").expedia)
#let inter-ic-threshold-pct       = pct(json-field("3-3-coverage.json", "ic_coverage_threshold"))
#let inter-ic-pairs-at-threshold  = int-str(json-field("3-3-coverage.json", "ic_coverage_pairs_at_or_above_threshold"))
#let inter-ic-offdiag-count       = int-str(json-field("3-3-coverage.json", "off_diagonal_count"))
